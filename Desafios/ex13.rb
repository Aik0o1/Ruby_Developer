 apiReturn = [
{title: "Omelete", 
ingredientes: "Ovo, salsinha, sal, queijo", 
...
ingredientes: "Farinha, ovos, açúcar, chocolate em pó, óleo, fermento, leite", 
...
{title: "Brigadeiro", 
ingredientes: "Leite condensado, manteiga, chocolate em pó", 
...
{title: "Pão Caseiro", 
ingredientes: "Farinha, leite morno, água morna, óleo, açúcar, sal, ovos, fermento biológico", 
...
ingredientes: "Carne moída, sal, cebola, alho, oregano, ovo", 
...
ingredientes: "Leite condensado, manteiga, leite, nozes", 
...
for i in offset..limit do
    puts apiReturn[i][:title]
    puts apiReturn[i][:ingredientes]
